...
For a case-study summarizing how CBB activity has complemented research activities at Scripps Research check out our publication in [PLOS Comp Bio](https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1013453). The manuscript folder here contains source data and analysis code. 
...
## [Seminars](https://github.com/SuLab/TSRI-CBB/tree/main/Seminars-Monthly) 
Also referred to as 'Research in Progress', these presentations are lab meeting-like seminars on all topics bioinformatics. Previous speakers can be contacted directly for a recording of their seminar. We are intentional in our speaker selection being representative across demographics, career stages, and topics.
