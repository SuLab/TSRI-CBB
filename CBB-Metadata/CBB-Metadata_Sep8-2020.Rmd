...
# Upload Data 
df <- read.csv(text=getURL("https://raw.githubusercontent.com/SuLab/TSRI-CBB/master/CBB-Metadata/TSRI-CBB-Metadata_LastUpdated-Sep8-2020.csv")) 
...
ggplot(pc, aes (x="", y = Freq, fill = .)) + 
  ...
  labs(fill = "Title",
       ...
       y = NULL) + 
  coord_polar("y")
ggsave("CBB-Position_piechart_Sep8-2020.png", dpi = 800) 
...
wc <- df$Topics %>% 
  ...
  data.frame()
## Create figure 
png("CBB-Topics_wordcloud_Sep8-2020.png")
...
ggplot(data=bc, aes(x=Language, y=Percentage, fill=Proficiency)) +
  ...
  theme_minimal()
ggsave("CBB-Proficiency_barchart_Sep8-2020.png", dpi = 800) 
